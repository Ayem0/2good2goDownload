                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-5 mb-lg-0 text-center text-lg-start">
                            ...
                            <div class="d-flex flex-column flex-lg-row align-items-center">
                                <div class ="col-lg-4">
                                <p class="lead fw-small text-muted mb-3 mt-3">Version Android</p>
                                ...
                                <div class ="col-lg-4">
                                <p class="lead fw-small text-muted mb-3 mt-3">Version Windows</p>
                            ...
                            <div class="device-wrapper">
                                <div class="device" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                    <div class="screen bg-black">
                                        ...
                                        <video muted="muted" autoplay="" loop="" style="max-width: 100%; height: 100%"><source src="assets/images/demo-screen.mp4" type="video/mp4" /></video>
                                    </div>
                                </div>
                            </div>
                        </div>
